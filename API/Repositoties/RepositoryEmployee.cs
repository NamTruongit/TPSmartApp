...
namespace TPApi.Repositoties
{
    public class RepositoryEmployee : IRepositoryEmployee
    {
        ...
        {
            var query = "EXEC Employee_Insert @FirstName,@LastName,@PhoneNumber,@Address,@DayOfBirth,@NativePlace";
        ...
        {
            var query = "EXEC Employee_Update @Id,@FirstName,@Lastname,@PhoneNumber,@Address,@DayOfBirth,@NativePlace";
            var parameters = new DynamicParameters();
